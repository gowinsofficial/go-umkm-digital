                    ...
                    <div class="card-body">
                        <form action="{{ route('eventship.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control w-50" id="whatsapp_member"
                                        placeholder="No. Whatsapp , Pakai (62): 62xxxxxxxxxxx" name="whatsapp_member" required />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type ="date" class="form-control w-50" id="tgl_event" rows="3" name="tgl_event" placeholder="Tanggal Event" required />
                                </div>
                            </div>
